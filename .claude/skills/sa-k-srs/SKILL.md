---
name: sa-k-srs
description: SRS (Spaced Repetition System) cho K module — SM-2 algorithm, Daily Review UI, scoring, retention, badge counts, due/new indicators.
---
...
## 6. Badge Counts & UI Indicators

### `dailyReviewDueCount` — ActivityBar badge
...
### `dueSrsCount` — blue dot trên KNode
