...
export function TaskList({ projectId }: TaskListProps) {
    ...
    const handleInlineDateUpdate = useCallback(
        ...
        [$user.userToken, loadTasks, projectId, setTaskGridIsLoading, getSubtasksOutsideRange, _console]
    );
    ...
    const handleDropTaskOntoTask = useCallback(
        ...
        [$user.userToken, loadTasks, projectId, setTaskGridIsLoading, _console]
    );
