 ...
 */
export function KWorkspaceView() {
    const { $user } = useAuthStore();
    const { allWorkspaces, isLoadingWorkspaces, isLoadingTree, isLoadingTreeByOpeningFolder, selectedWorkspaceId, setSelectedWorkspaceId } = useKWorkspaceStore();
    const { KloadAllWorkspaces, loadTree } = KuseWorkspaceLoader();
    const { saveNewsBeforeNavigate } = KuseWorkspaceHelper();
