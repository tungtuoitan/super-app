...
import { getProjectStatusColors } from "@/Components/Project/ProjectStatusBadge";
import { TIMELINE_HEADER_HEIGHT, WEEKEND_STRIPE_BG, formatDateHeader, isWeekend, isToday, isFirstDayOfMonth } from "@/utils/task/TaskGrid.utils";
import { useMultiTimelineStore } from "@/store/task/useMultiTimeline.store";
import { useMultiTimelineSelector } from "@/Selectors/multipleProject/useMultiTimeline.selector";
import { useMultiTimelineHelper } from "@/hooks/multiProject/useMultiTimeline.helper";
import { useMultiTimelineHeadless } from "@/HeadlessComponents/multiProject/useMultiTimeline.headless";
import { ProjectBar } from "./small/ProjectBar";
import { PRO_ROW_HEIGHT } from "../../utils/project/multiProjectDetail.constants";
